...
<Tabs items={['ND Main', 'ND Lite', 'ND Legacy']}>
    <Tabs.Tab>
        ND Main is for users who want the full experience that ND has to offer, this includes all released free resources & everything you need to get started creating the best server you can.
    ...
    <Tabs.Tab>
        ND Lite is for users who want a simple experience with only the essentials included. This allows you to build out the server exactly how you want.
    ...
    <Tabs.Tab>
        ND Legacy is for users who want to use ND as an add-on to enhance their experience rather than using it as a full fledged framework. This recipe comes with vMenu included & the old character creation system.
